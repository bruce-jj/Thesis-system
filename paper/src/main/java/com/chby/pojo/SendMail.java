...
public class SendMail {
    ...
    // 发件人的邮箱账号
    public static String sendEmailAccount = "370216714@qq.com";
    // 发件人的邮箱的授权码
    public static String sendEmailPassword = "lxmnizzxftfrbjbi";
    // 发件人邮箱的SMTP服务器地址
