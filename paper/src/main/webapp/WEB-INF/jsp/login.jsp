                        ...
                        <div id="reg" style="margin: 50px;display: none">
                            <form action="user/add" method="post">
                                ...
                                <div class="input-group input-group-lg" style="margin: 10px auto;width:100%;">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-addon"> <span class="glyphicon glyphicon-user"></span></span>
                                        <input  id="username" onchange="checkUser()" type="text" autocomplete="off"  class="form-control user" name="reg_username" placeholder="请输入用户名">
                                    </div>
                                    <span id="note"></span>
                                    <br>
                                    <div class="input-group input-group-lg">
...
<script>
    //ajax 判断是否已经被注册
    function checkUser(){
        $.get("/CheckUserServlet",{name:$("#username").val()},
            function(data){
                $("#note").html(data);
            });
    }
